...
public class ProjectService {
	...
	public Project saveorUpdateProject(Project project, String principalName) {
		...
		if(project.getId()!=null) {
			...
			getProjectById(existingProject.getIdentifier(), principalName);
		}
		...
		try {			
			...
			if(project.getId()==null) {									//if first time creating project
				...
				project.setBacklog(backlogRepo.findByProjectIdentifier(project.getIdentifier()));
			}
	...
	public Project getProjectById(String identifier, String principalName) {
		...
		if(project==null) {
			throw new ProjectIdException("No project with '"+ identifier.toUpperCase() +"' exists");
		}
